...
export const SearchResultCard: React.FC<SearchResultCardProps> = ({ verse, isSelected, onSelect, searchQuery, isPrimary, isReadingMode }) => {
  ...
  if (isReadingMode) {
    return (
      <div 
        ...
        className={`
          py-4 border-b border-paper-200 dark:border-slate-800 transition-colors duration-300
    ...
    <div 
      ...
      className={`
        ...
        ${isSelected 
          ...
          : isPrimary
          ? 'bg-paper-100/50 dark:bg-slate-800/60 border-gold-500/50 hover:bg-white dark:hover:bg-slate-800 hover:shadow-sm hover:border-gold-500'
